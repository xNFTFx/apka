...
namespace apka.Controllers
{
    public class AutorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAutor,Nazwa")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAutor,Nazwa")] Autor autor)
        {
            if (id != autor.IdAutor)
            {
                return NotFound();
        ...
        {
            return _context.Autorzy.Any(e => e.IdAutor == id);
        }
    }
}
